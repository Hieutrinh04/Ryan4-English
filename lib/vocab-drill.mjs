...
export const DRILL_MODES = [
  { value: "card", label: "Thẻ ghi nhớ", icon: "cards", hint: "Lật thẻ và tự đánh giá" },
  { value: "type", label: "Nhớ từ", icon: "keyboard", hint: "Nghĩa Việt → gõ tiếng Anh" },
  { value: "listen", label: "Nghe – viết", icon: "volume", hint: "Nghe phát âm → gõ lại từ" },
  { value: "reverse", label: "Nhớ nghĩa", icon: "swap", hint: "Tiếng Anh → nhớ nghĩa Việt" },
  { value: "quiz", label: "Chọn đáp án", icon: "target", hint: "Chọn nghĩa đúng trong 4 đáp án" },
  { value: "mixed", label: "Luyện tổng hợp", icon: "shuffle", hint: "Luân phiên nhiều kỹ năng", badge: "Đề xuất" },
];
