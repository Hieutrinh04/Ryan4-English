...
export const DRILL_MODES = [
  ...
  { value: "reverse", label: "Đảo ngược", icon: "⇄", hint: "Xem từ tiếng Anh rồi nhớ lại nghĩa tiếng Việt" },
  { value: "quiz", label: "Trắc nghiệm", icon: "◉", hint: "Chọn đúng nghĩa tiếng Việt của từ tiếng Anh" },
